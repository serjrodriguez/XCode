...
class ListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let image = UIImage(named: "logo_elsemanario.png")
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let backButtonImage: UIImage = UIImage(named: "menu.png")!
        backButtonImage.resizableImageWithCapInsets(UIEdgeInsetsMake(0, 13, 0, 6))
        backBtn.setBackButtonBackgroundImage(backButtonImage, forState: .Normal, barMetrics: .Default)
